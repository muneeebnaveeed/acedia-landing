...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-[#A2FF00] font-serif relative overflow-clip">
      <div className="absolute right-0 -rotate-90 top-[-40%] z-1">
        <Image
      ...
      <div className="px-10 py-[250px] z-10">
        <div className="flex items-center justify-center">
          ...
          <div className="z-10 flex items-center justify-center w-full gap-8 -translate-x-40 ">
            <a href="https://twitter.com/acediadevs" target="_blank">
              <Image className="hover:scale-110 transition duration-500 cursor-pointer"
